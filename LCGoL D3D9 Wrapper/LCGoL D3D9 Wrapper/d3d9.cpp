...
STDMETHODIMP f_iD3D9::QueryInterface(REFIID riid, void ** ppvObj)
{
...
STDMETHODIMP f_IDirect3DDevice9::QueryInterface(REFIID riid, void ** ppvObj)
{
...
STDMETHODIMP f_IDirect3DDevice9::MultiplyTransform(D3DTRANSFORMSTATETYPE State, CONST D3DMATRIX *pMatrix)
{
...
STDMETHODIMP f_IDirect3DDevice9::SetLight(DWORD Index, CONST D3DLIGHT9 *pLight)
{
